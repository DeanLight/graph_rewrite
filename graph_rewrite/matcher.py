...
def find_struct_matches(input: DiGraph, pattern: DiGraph, verbose: bool = False) -> List[Dict[str, Hashable]]:
    """
    Finds structural matches (ignores attributes) of a pattern graph inside an input graph, and returns mappings for each match.
